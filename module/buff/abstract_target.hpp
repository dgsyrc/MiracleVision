...
namespace abstract_target
{
  ...
  void Target::updateVertex(cv::Mat &_img)
  {
    ...
    // 画出各个顶点 红黄蓝绿
    cv::circle(_img, points_2d_[0], 2, cv::Scalar(0, 0, 255), -1);
    cv::circle(_img, points_2d_[1], 2, cv::Scalar(0, 255, 255), -1);
    cv::circle(_img, points_2d_[2], 2, cv::Scalar(255, 155, 0), -1);
